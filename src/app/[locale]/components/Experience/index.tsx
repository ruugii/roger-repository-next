  ...
  return (
    <section className="flex flex-col gap-8 row-start-2 items-center sm:items-start bg-white rounded-lg p-8 text-black w-full" id="experience">
      ...
      <Timeline
        items={[
          {
            date: `${t('year.2026')} - ${t('year.2026')}`,
            title: t('enterprice.EYClick.title'),
            description: t.rich('enterprice.EYClick.description', {
              ul: (chunks) => (
                <ul>
                  {chunks}
                </ul>
          ...
          },
          {
            ...
            title: t('enterprice.cem.title'),
            description: t.rich('enterprice.cem.description', {
              ul: (chunks) => (
                <ul>
                  {chunks}
                </ul>
